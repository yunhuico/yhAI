define(['app'], function(app) {
	...
	app.compileProvider.directive("paginations", function() {
		return {
			...
			+ '<div onselectstart="return false" class="button_type" ng-click= jump("first")>{{"directive.pagination.first_page" | translate}}</div>' 
			+ '<div onselectstart="return false" class="button_type" ng-click= jump("before")>{{"directive.pagination.previous_page" | translate}}</div>' 
			...
			+ '<div onselectstart="return false" class="button_type" ng-click=jump("next")>{{"directive.pagination.next_page" | translate}}</div>' 
			+ '<div onselectstart="return false" class="button_type" ng-click=jump("end")>{{"directive.pagination.last_page" | translate}}</div>'
			+ '<div style="display:inline-block;margin-left:20px;font-size:12px;">{{"common.total" | translate}}{{total}}{{"common.record" | translate}}</div>' 
			+ '</div>',
			replace: true,
			restrict: 'AECM',
			scope: {
